...
void MainWindow::connectSlots()
{
    ...
    connect(suggestBox,&SuggestBox::selectSearchedSong,this,&MainWindow::onAddMusic);
    connect(ui->listofMusiclist,&MusiclistListWidget::addMusic,this,&MainWindow::onAddMusic);
    connect(playStateWidget,&PlayStateWidget::curPictureClicked,this,&MainWindow::showCurMusicInfo);
}
